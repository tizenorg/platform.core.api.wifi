 ...
 * @see wifi_ap_is_wps_supported()
 */
int wifi_connect_by_wps_pbc_without_ssid(wifi_connected_cb callback, void *user_data);
 ...
 * @see wifi_ap_is_wps_supported()
 */
 int wifi_connect_by_wps_pin_without_ssid(const char* pin, wifi_connected_cb callback, void* user_data);
 ...
 * @retval #WIFI_ERROR_NOT_SUPPORTED	Not supported
 */
int wifi_ap_set_dns_config_type(wifi_ap_h ap, wifi_address_family_e address_family, wifi_dns_config_type_e type);
 ...
 * @retval #WIFI_ERROR_NOT_SUPPORTED	Not supported
 */
int wifi_ap_get_dns_config_type(wifi_ap_h ap, wifi_address_family_e address_family, wifi_dns_config_type_e* type);
 ...
 * @retval #WIFI_ERROR_NOT_SUPPORTED   Not supported
 */
int wifi_ap_get_disconnect_reason(wifi_ap_h ap, wifi_disconnect_reason_e* disconnect_reason);
