...
EXPORT_API int wifi_tdls_set_connected_cb(wifi_tdls_connected_cb callback, void* user_data)
{
	CHECK_FEATURE_SUPPORTED(WIFI_FEATURE);
	...
	return _wifi_set_tdls_connected_cb(callback, user_data);
}

EXPORT_API int wifi_tdls_unset_connected_cb(void)
{
	CHECK_FEATURE_SUPPORTED(WIFI_FEATURE);
	...
	return _wifi_unset_tdls_connected_cb();
}

EXPORT_API int wifi_tdls_set_disconnected_cb(wifi_tdls_disconnected_cb callback, void* user_data)
{
	CHECK_FEATURE_SUPPORTED(WIFI_FEATURE);
	...
	return _wifi_set_tdls_disconnected_cb(callback, user_data);
}

EXPORT_API int wifi_tdls_unset_disconnected_cb(void)
{
	CHECK_FEATURE_SUPPORTED(WIFI_FEATURE);
	...
	return _wifi_unset_tdls_disconnected_cb();
}
